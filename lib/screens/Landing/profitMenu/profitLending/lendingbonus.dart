...
class _LendingBonusTabState extends State<LendingBonusTab> {
  ...
  Widget build(BuildContext context) {
          ...
          child: Row(
            children: [
              Column(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Today Bonus",style: TextStyle(color: Colors.black54, fontFamily: "Roboto-regular", fontSize: 12.sp,)),
    ...
    Text("Lending Bonus from 5000ADX",style: TextStyle(color: Colors.black, fontFamily: "Roboto-regular", fontSize: 10.sp,)),
    ],),
                Spacer(),
